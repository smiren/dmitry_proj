    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_activeted', models.BooleanField(db_index=True,
                 default=True, verbose_name='Подтвержден email?')),
                ('phone', models.CharField(blank=True, max_length=10, validators=[django.core.validators.RegexValidator(
                    regex='^(|[\\d]{10})$')], verbose_name='Номер телефона без восьмерки')),
                ('address', models.CharField(blank=True, max_length=200,
                 verbose_name='Предпочтительный адрес доставки')),
